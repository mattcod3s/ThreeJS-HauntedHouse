...
// Directional light or Moon Light
...
const tick = () =>
{
    ...
    ghost2.position.x = Math.cos(ghost2Angle) * (Math.abs(Math.sin(elapsedTime))) * 6
    ghost2.position.z = Math.sin(ghost2Angle) * (Math.abs(Math.sin(elapsedTime))) * 6
    ghost2.position.y = Math.sin(elapsedTime * 4) + Math.sin(elapsedTime * 0.25)

    const ghost3Angle = -elapsedTime * 0.89
    ghost3.position.x = Math.cos(ghost3Angle) * (Math.abs(Math.sin(elapsedTime))) * 9
    ghost3.position.z = Math.sin(ghost3Angle) * (Math.abs(Math.cos(elapsedTime))) * 9
